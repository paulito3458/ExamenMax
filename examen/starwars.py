...
# Inicializar
pygame.init()
pygame.mixer.music.load("perfume.ogg")
...
# Carga imágenes
fondo = pygame.image.load("paulo4.jpg").convert()
nave_arr = pygame.image.load("arriba1.png").convert_alpha()
nave_abj = pygame.image.load("abajo1.png").convert_alpha()
nave_izq = pygame.image.load("izquierda1.png").convert_alpha()
nave_der = pygame.image.load("derecha1.png").convert_alpha()

aste_1a = pygame.image.load("misil.png").convert_alpha()
aste_1b = pygame.image.load("misil1.png").convert_alpha()
aste_1c = pygame.image.load("misil2.png").convert_alpha()
aste_1d = pygame.image.load("misil.png").convert_alpha()
...
aste_2a = pygame.image.load("misil1.png").convert_alpha()
aste_2b = pygame.image.load("misil2.png").convert_alpha()
aste_2c = pygame.image.load("misil.png").convert_alpha()
aste_2d = pygame.image.load("misil1.png").convert_alpha()
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "               Jose torres no puede quedarse quieto ",
            "              ha estado en cuarentena demasiado tiempo",
            "                    es tiempo de escapar de esta guerra",
            "                    huye con el auto de josee torres",
            "       Intenta traspasar las adversidades que le presentan.",
            "",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "      No has conseguido escapar, no estes triste por matar ",
                "      a jose torres, por suerte sus amigos lo rescataron ",
                "             quieres probar suerte?.  ",
                "          repara tu auto y vuelve a intentarlo? ",
                "",
                "              Pulsa 's' para volverlo a intentar",
                "              Pulsa 'n' para salir del juego"]

            historia_ganado = [
                "      Excelente, acabas de huir y que no te falte   ",
                "         ninguna extermidad, felicidades.    ",
                "          Ahora estas en un lugar mejor     ",
                "          ¿Quieres embarcarte en un nuevo escape?   ",
                "",
